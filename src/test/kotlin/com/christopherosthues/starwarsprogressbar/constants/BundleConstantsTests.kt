...
class BundleConstantsTests {
    ...
    companion object {
        ...
        fun bundleConstants(): Stream<Arguments> = Stream.of(
            ...
            Arguments.of("configuration.showVehicle", BundleConstants.SHOW_ICON),
            Arguments.of("configuration.showVehicleName", BundleConstants.SHOW_NAME),
            ...
            Arguments.of("configuration.sameVehicleVelocity", BundleConstants.SAME_VELOCITY),
            Arguments.of("configuration.enableNewVehicles", BundleConstants.ENABLE_NEW),
            ...
            Arguments.of("configuration.changeVehicleAfterPass", BundleConstants.CHANGE_AFTER_PASS),

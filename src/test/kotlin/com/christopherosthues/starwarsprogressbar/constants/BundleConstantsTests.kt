...
class BundleConstantsTests {
    ...
    companion object {
        ...
        fun bundleConstants(): Stream<Arguments> = Stream.of(
            ...
            Arguments.of("configuration.showIcon", BundleConstants.SHOW_ICON),
            Arguments.of("configuration.showName", BundleConstants.SHOW_NAME),
            ...
            Arguments.of("configuration.sameVelocity", BundleConstants.SAME_VELOCITY),
            Arguments.of("configuration.enableNew", BundleConstants.ENABLE_NEW),

package com.christopherosthues.starwarsprogressbar.activities
...
import com.christopherosthues.starwarsprogressbar.ui.configuration.StarWarsProgressConfigurable
...
class PluginUpdatedActivity: DumbAware {
    ...
    private fun displayUpdateNotification(project: Project, version: String) {
        ...
        notification.addAction(object: DumbAwareAction(StarWarsBundle.message(BundleConstants.NOTIFICATION_CONFIGURE)) {
